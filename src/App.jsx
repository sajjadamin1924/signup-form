        ...
        <div className="w-1/2 flex flex-col p-4 bg-white p-6">
          <form className="w-3/4 space-y-4 mt-4">
            ...
            <div className="flex space-x-4  relative">
              <img src="name.png" alt="Student" className=" absolute" />
              <input
                type="text"
                className="w-full p-3  border border-gray-600 rounded-3xl "
            ...
            <div className="flex space-x-4  relative">
              <img src="email.png" alt="Student" className="absolute" />
              <input
                type="email"
                className="w-full p-3 border border-gray-600 rounded-3xl"
            ...
            <div className="relative w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full p-3 border border-gray-600 rounded-3xl pr-10"
